import { SocialMedia } from './social-media-channel';

export const SocialMediaDetail: SocialMedia [] = [
    { name: 'Facebook', icon: '../../assets/icon-facebook.svg', username: '@nathanf', followers: 1987, label: 'Followers', followersDifference: 12, kpis: {kpi1: 'Page Views', kpi1Value: 87, kpi2: 'Likes', kpi2Value: 52}},
